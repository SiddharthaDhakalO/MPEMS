      ...
      <div className="bg-[#FEF9C3] py-12 px-4 md:px-8 border-b border-[#FDE047]/40">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-[#6B7280] leading-relaxed">
            Glimpses of joyful learning, events, sports and daily life at Sunrise Primary School.
          </p>
        </div>
      </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
            {filtered.map(item => (
              <div
                key={item.id}
                className={`${item.bg} border-2 ${item.border} rounded-2xl aspect-square flex flex-col items-center justify-center gap-2 hover:scale-105 hover:shadow-lg transition-all duration-200 cursor-pointer`}
              >
