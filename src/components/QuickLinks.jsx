        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {links.map(link => (
            <Link
              key={link.label}
              to={link.to}
              className={`bg-white border-2 ${link.color} rounded-2xl p-5 flex flex-col items-center text-center gap-2 transition-all duration-200 hover:-translate-y-1 shadow-sm`}
            >
